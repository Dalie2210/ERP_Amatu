...
export default function TrazabilidadPage() {
  ...
  return (
    <div className="space-y-8 max-w-[1440px] mx-auto">
      <div>
        <h1 className="text-3xl font-bold font-heading tracking-tight">Trazabilidad de Lote</h1>
        <p className="text-muted-foreground mt-1">
          Rastrea un lote de insumo o de producto terminado: recepción → producción → PT → despacho.
        </p>
      </div>
